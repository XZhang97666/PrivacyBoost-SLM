...
class FiDT5(T5ForConditionalGeneration):
    ...
    def generate(self, input_ids, attention_mask, **outputkwargs):
        self.encoder.n_passages = input_ids.size(1)
        # import pdb;pdb.set_trace()
    ...
    def wrap_encoder(self, use_checkpoint=False):
        ...
        self.encoder.main_input_name=self.encoder.encoder.main_input_name
...
class EncoderWrapper(torch.nn.Module):
    ...
    def __init__(self, encoder, use_checkpoint=False):
        ...
        # import pdb;pdb.set_trace()
        # input_attrs = vars(encoder)
        # for attr_name, attr_value in input_attrs.items():
